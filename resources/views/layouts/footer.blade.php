        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
            ...
            <div>
                <h3 class="text-white font-bold text-lg mb-6 relative inline-block">
                    Services
                    <span class="absolute bottom-0 left-0 w-1/2 h-0.5 bg-gradient-to-r from-blue-400 to-purple-500"></span>
                </h3>
                <ul class="space-y-3">
                    <li>
                        <a href="{{ url('/services#seo') }}" class="footer-link group flex items-center">
                            <span class="w-2 h-2 bg-blue-400 rounded-full mr-3 group-hover:bg-blue-300 transition-colors"></span>
                            SEO Optimization
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/services#social') }}" class="footer-link group flex items-center">
                            <span class="w-2 h-2 bg-purple-400 rounded-full mr-3 group-hover:bg-purple-300 transition-colors"></span>
                            Social Media Marketing
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/services#content') }}" class="footer-link group flex items-center">
                            <span class="w-2 h-2 bg-pink-400 rounded-full mr-3 group-hover:bg-pink-300 transition-colors"></span>
                            Content Marketing
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/services#ppc') }}" class="footer-link group flex items-center">
                            <span class="w-2 h-2 bg-green-400 rounded-full mr-3 group-hover:bg-green-300 transition-colors"></span>
                            PPC Advertising
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/services#email') }}" class="footer-link group flex items-center">
                            <span class="w-2 h-2 bg-yellow-400 rounded-full mr-3 group-hover:bg-yellow-300 transition-colors"></span>
                            Email Marketing
                        </a>
                    </li>
                </ul>
        ...
        <div class="border-t border-gray-700 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="text-gray-400 text-sm">
                    &copy; {{ date('Y') }} GrowIn. All rights reserved.
                </div>
                <div class="flex flex-wrap justify-center md:justify-end space-x-6 text-sm">
                    ...
                    <a href="{{ url('/cookies') }}" class="footer-link">Cookie Policy</a>
